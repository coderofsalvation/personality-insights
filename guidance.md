...
Clients and business partners who are interested in using the {{site.data.keyword.personalityinsightsshort}} service for mental health diagnosis are welcome to design and conduct ground truth experiments for such use cases. Active research in this area includes work that relates personality to health outcomes ([Israel and others, 2014](/docs/services/personality-insights/references.html#israel2014)). It also includes work that aims to predict postpartum and other forms of depression from social media ([De Choudhury and others, 2013a](/docs/services/personality-insights/references.html#dechoudhury2013a), and [De Choudhury and others, 2013b](/docs/services/personality-insights/references.html#dechoudhury2013b)).
