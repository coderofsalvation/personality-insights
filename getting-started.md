...
1.  Go to the [{{site.data.keyword.personalityinsightsshort}} service](https://console.bluemix.net/catalog/services/personality-insights/){: new_window} and either sign up for a free Bluemix account or log in.
