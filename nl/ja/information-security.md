...
-   EU 内の場合、[EU で作成された {{site.data.keyword.cloud_notm}} Watson リソースのサポートの要求 (Requesting support for IBM Cloud Watson resources created in the European Union)](/docs/services/watson?topic=watson-gdpr-sar#request-EU) を参照してください。
...
## Personality Insights サービスでのデータのラベル付けと削除
{: #gdpr-personality-insights}

{{site.data.keyword.personalityinsightsfull}} サービスはユーザーのデータを処理しますが、保管しません。 {{site.data.keyword.personalityinsightsshort}} サービスのユーザーが、このサービスのデータを識別、保護、削除するための処置を行う必要はありません。
