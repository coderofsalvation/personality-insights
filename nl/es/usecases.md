...
Las secciones siguientes sugieren solo algunas de las aplicaciones potenciales del servicio {{site.data.keyword.personalityinsightsshort}}. Utilice esta información para reactivar sus propias aplicaciones o para desarrollar sus propias ideas innovadoras.
...
El servicio {{site.data.keyword.personalityinsightsshort}} puede coincidir con personas y grupos. Las posibles permutaciones pueden alentar las conexiones uno a uno, individuo a grupo, grupo a individuo, y grupo a grupo haciendo coincidir las características de personalidad en los dominios siguientes:
