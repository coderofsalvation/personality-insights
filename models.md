...
-   *Big Five* personality characteristics represent the most widely used model for generally describing how a person engages with the world. The model includes five primary dimensions:
    ...
    -   [*Openness*](/docs/services/personality-insights/openness.html) is the extent to which a person is open to experiencing a variety of activities.

    Each of these top-level dimensions has six facets that further characterize an individual according to the dimension.
-   [Needs](/docs/services/personality-insights/needs.html) describe which aspects of a product will resonate with a person. The model includes twelve characteristic needs.
